...
Appointment.create(service: "shave", customer_id: 1, barber_id: 1)
Appointment.create(service: "dye", customer_id: 1, barber_id: 1)
Appointment.create(service: "trim", customer_id: 1, barber_id: 1)
Appointment.create(service: "countour", customer_id: 1, barber_id: 1)